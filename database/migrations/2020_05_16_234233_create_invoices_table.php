...
class CreateInvoicesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('invoices', function (Blueprint $table) {
            ...
            $table->integer('product_one_price')->nullable()->unsigned();
            $table->integer('product_two_price')->nullable()->unsigned();
            $table->integer('product_three_price')->nullable()->unsigned();
            $table->integer('product_four_price')->nullable()->unsigned();
            ...
            $table->integer('product_one_total')->nullable()->unsigned();
            $table->integer('product_two_total')->nullable()->unsigned();
            $table->integer('product_three_total')->nullable()->unsigned();
            $table->integer('product_four_total')->nullable()->unsigned();
